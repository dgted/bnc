...
def Bdtoday24(start_date, end_date, path, listbox_selected_category):
    import bs4
    import requests
    import csv
    import pandas as pd
    ...
    base_address = "http://bdtoday24.com"
    # http://bdtoday24.com/2020/11/11/
    ...
    def get_sub_links(main_page_link, path, listbox_selected_category):
        ...
        # print(soup)
        newsArticleDivs = soup.find_all("h2", {"class": "post-title"})
    ...
    def append_to_csv(row, path , category):
        ...
        CSV_LINK = path + "/Bdtoday24_" + category + "_news.csv"
    ...
    def get_title_and_content(url, news_date, path , listbox_selected_category):
        ...
        print(newsTitle)
        article_text = soup.find("div", {"class": "entry"})
